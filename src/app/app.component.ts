...
@Component({
  ...
  <header class="bg-base-300 "> 
    <div class="title flex h-20 justify-center w-full p-2">
      <img class="p-2" src={{logo}} />
      <h1 class="text-7xl font-['AmaticSC']">{{title}}</h1> 
      <img class="p-2" src={{logo}} />

    </div>
    <div class="navbar flex flex-row justify-center w-full">
  ...
  <footer class="footer items-center p-4 bg-base-300 text-neutral-content m-t-10">
