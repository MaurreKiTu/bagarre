...
@Component({
	...
	template: `
  	<div tabindex="0">
		<p>{{details}}</p>
		<div id="item-1" class="flex flex-col">
			<h4>Jeu de Base</h4>
		</div>
		<div id="item-1-1" class="flex flex-col">
		<h5>Vue d’ensemble</h5>
		<p>La bagarre est un jeu rapide de combat. Le but est de rester en vie ! Si c'est votre première partie, on recommande de jouer d’abord avec les règles de base, puis d’ajouter les personnages lorsque vous avez pris le jeu en main.</p>
		</div>
		<div id="item-1-2" class="flex flex-col">
		<h5>Mise en place</h5>
		<p>Dans ce jeu, l’as vaut 1, le valet vaut 11, la dame 12 et le roi 13. Mélangez un jeu de 52 cartes et distribuez 3 cartes à chaque joueur.se, disposées face visible comme suit (exemple ci-contre) : <img class="img-fluid p-2" src="img/table.png" alt="Placement">
		<ul>
		...
		<div id="item-1-3" class="flex flex-col">
		<h5>Déroulement d’un tour</h5>
		...
		<p>Lorsque les PV d’un.e joueur.se tombent à zéro, il/elle est éliminé.e, et la personne qui l’a tué.e joue immédiatement une action supplémentaire. En cas de meurtres multiples dans le même tour, plusieurs actions supplémentaires peuvent être gagnées.<br />
		...
		<div id="item-1-4" class="flex flex-col">
		<h5>Fin de partie</h5>
		<p>La dernière personne en vie dans la partie gagne.</p>
		</div>
		<div id="item-1-5" class="flex flex-col">
		<h5>Autres règles</h5>
		...
		<div id="item-2" class="flex flex-col">
		...
		<div id="item-3" class="flex flex-col">
		<h4>Personnages avancés</h4>
		<p class="character" id="item-3-1"><img src="img/alchemist.png" class="float-start img-icon p-1 m-1" alt="Alchimiste"><b>Alchimiste</b> : vous disposez de 3 potions à usage unique :
		<ul>
		...
		<div id="item-4" class="flex flex-col">
		<h4>Scénarios</h4>
...
export class RulesComponent {
	...
	details = 'Durée : 10 min - Joueur.ses : 2-6 - Matériel : 1 jeu de 52 cartes classique';
}
