      ...
      <div class="m-4">
        ...
        <div class="cards grid gap-4 grid-cols-6 m-5  ">
          <div class="card flex  bg-stone-300 shadow-xl col-span-2 col-start-2">
            ...
            >
              Je change le bouclier de X
            </h2>
            <p class="text-justify p-4 text-black">
              Défaussez le bouclier de la personne annoncée et remplacez le par
              la carte piochée.
            </p>
          </div>
          ...
          <div class="card flex bg-stone-300 shadow-xl col-span-2 col-start-2">
            ...
            <p class="text-justify p-4 text-black">
              La personne annoncée perd autant de vie que la différence entre la
              carte piochée et son bouclier. Elle met à jour ses PV en
              défaussant sa ou ses cartes PV perdues et prend dans la défausse
            ...
            >
              <li>
                ...
                dans la pioche, et la mélange ensuite.
              </li>
              <li>
                Si le bouclier de la personne attaquée est supérieur à la valeur
                de l'attaque, l'attaque est sans effet.
              </li>
          ...
          <div class="card flex bg-stone-300 shadow-xl col-span-2">
            <h2
              class="text-center p-2 bg-slate-600  rounded-t-lg card-title justify-center"
            >
              Je charge une attaque
            </h2>
            <p class="text-justify p-4 text-black">
              Mettre la carte tirée face cachée devant soi sans la regarder. La
              prochaine fois que vous attaquez, révélez la charge qui se cumule
              à la carte d'attaque piochée. Les deux cartes sont ensuite
              défaussées.
            </p>
            <ul
            ...
            >
              Attention :
              <li>
                Si vous perdez de la vie en ayant une attaque chargée, vous
                devez défausser votre charge.
              </li>
              <li>
                Vous ne pouvez avoir qu'une seule attaque chargée à la fois.
              </li>
              <li>
                Un joueur avec une charge n'est pas obligé d'attaquer, mais s'il
                attaque, il est obligé d'utiliser sa charge.
              </li>
            </ul>
          </div>
        </div>
...
export default class RulesRoute {
  ...
  charactersEasy = computed(() =>
    this.characters().filter((char) => !char.difficult)
  );
